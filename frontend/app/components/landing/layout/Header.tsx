/* Header para la PAGINA PRINCIPAL y para que se visualice en cada ventana lo importamos 
con la funcion Header() a las ventanas que querramos que aparezca */
    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
      <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            href="/dashboard"
            className="flex items-center gap-2 text-gray-950 hover:text-blue-600 font-semibold"
          >
            <LayoutDashboard size={20} /> Dashboard
          </Link>
          <Link
            href="/rooms"
            className="flex items-center gap-2 text-gray-950 hover:text-blue-600"
          >
